...
public class UserService : IUserService
{
    ...
    public List<User> GenerateSampleUsers(int numberOfUsers)
    {
        ...
        string[] firstNames = { "호원", "철수", "영희", "민수", "지민", "서연", "하준", "예린", "도윤", "수빈", "지우", "유진", "민재", "서준", "지안", "하율", "예은", "도현", "수연", "지후", "유나", "민서", "서하", "지유", "하린", "예지", "도연", "수아", "지민", "유빈", "민규", "서영", "지성", "하은", "예솔", "도윤", "수현", "지혜", "유리", "민찬", "서진", "지수", "하람", "예나", "도윤", "수빈", "지영", "유정", "민호", "서율", "지은", "하영", "예슬", "도현", "수진", "지혜", "유림" };
